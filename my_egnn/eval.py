...
from model import EmbeddingImagenet, GraphNetwork
import shutil
import os
import random
...
if __name__ == '__main__':
    ...
    tt.arg.test_model = 'D-mini_N-5_K-1_L-3_B-40_SEED-222' if tt.arg.test_model is None else tt.arg.test_model
    ...
    checkpoint = torch.load('asset/checkpoints/{}/'.format(exp_name) + 'model_best.pth.tar',map_location=tt.arg.device)
    #checkpoint = torch.load('./trained_models/{}/'.format(exp_name) + 'model_best.pth.tar',map_location=tt.arg.device)
